...
df['Hitzerekord vom 13. August 2003 (36°)'] = 36

df = df[['Stundenminimum', 'Stundenmaximum', 'Hitzerekord vom 13. August 2003 (36°)']]
...
update_chart(
    ...
    data = df.reset_index().set_index('date')[['Stundenminimum', 'Stundenmaximum', 'Hitzerekord vom 13. August 2003 (36°)']],
