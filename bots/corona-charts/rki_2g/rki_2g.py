...
if __name__ == '__main__':
    try:
        ...
        # run function
        update_chart(id='9dd87b7667e84ce621ab705db264e761', notes='¹ Bis 15. 12. sind strengere Regeln erlaubt.<br>² NZZ-Schätzung inklusive Nachmeldungen.<br><br>Stand: ' +
