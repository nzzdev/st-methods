...
if __name__ == '__main__':
    try:
        ...
        dw.update_metadata(chart_id=dw_id_fr, properties=date)
        dw.update_description(
            chart_id=dw_id, source_url=dw_source_ch, source_name='Bundesnetzagentur/Entso-E', intro='Wöchentlicher grenzüberschreitender Stromhandel Deutschlands (Export-Import-Saldo), in GWh<br><br><a target="_self" href="https://datawrapper.dwcdn.net/G2Vtz/" style="background:#fff; color: #000; border: 1px solid #d4d6dd;box-shadow: 0 1px 3px 0 rgba(0,0,0,.05); border-radius: 0px; padding:1px 6px; font-weight:400; cursor:pointer; outline: none;opacity: 1; text-decoration: none;padding:1px 6px">Gesamt</a> &nbsp;<a target="_self" href="https://datawrapper.dwcdn.net/XJFzP/" style="background:#fff; color: #000; border: 1px solid #d4d6dd;box-shadow: 0 1px 3px 0 rgba(0,0,0,.05); border-radius: 0px; padding:1px 6px; font-weight:400; cursor:pointer; outline: none;opacity: 1; text-decoration: none;padding:1px 6px">Frankreich</a> &nbsp;<a target="_self" href="https://datawrapper.dwcdn.net/BjzEn/" style="background:#fff; color: #000; border: 1px solid #d4d6dd;box-shadow: 0 1px 3px 0 rgba(0,0,0,.05); border-radius: 0px; padding:1px 6px; font-weight:400; cursor:pointer; outline: none;opacity: 1; text-decoration: none;padding:1px 6px"><b>Schweiz</b></a>')
