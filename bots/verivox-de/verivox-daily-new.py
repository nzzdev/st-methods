...
if __name__ == '__main__':
    try:
        ...
        cur.execute(
            "SELECT * FROM ELECTRICITY WHERE \"Datum\" = \'2022-8-16\' ORDER BY \"Postleitzahl\", \"Ort\", \"Ortsteil\" ")
        ...
        cur.execute(
            "SELECT * FROM GAS WHERE \"Datum\" = \'2022-8-16\' ORDER BY \"Postleitzahl\", \"Ort\", \"Ortsteil\" ")
        df = cur.fetch_pandas_all()
