...
if __name__ == '__main__':
    try:
        ...
        if not (d.today().weekday() == 0 and d.hour < 6):  # GMT+2
            ...
            date = {'annotate': {
                'notes': f'Negative Werte in Rot bedeuten Importe, positive Werte in Blau Exporte. Nachmeldungen möglich.<br><br>Stand: {dnotes}'}}
