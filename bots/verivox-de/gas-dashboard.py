...
if __name__ == '__main__':
    try:
        ...
        meta_storage = {'indicatorTitle': 'Gasspeicher', 'date': timestamp_str, 'indicatorSubtitle': f'Füllstand; Ziel: 40 % am 1. 2.', 'value': diff_storage, 'valueLabel': f'{diff_storage_str} %',
