...
s = requests.Session()
s.headers = headers
# r = s.get('https://www.coop.ch/de/lebensmittel/brot-backwaren/c/m_0115/facets?q=%3AmostlyBought&sort=mostlyBought&pageSize=60&compiledTemplates%5B%5D=productTile-new&openFilter=worldNameFacet&changedFilter=worldNameFacet&_=1663678558780')
r = s.get('https://www.coop.ch')
print(r.text)
print(r)
